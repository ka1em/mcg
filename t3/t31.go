...
func drawPoint(osvg *svg.SVG, pnt int, process int) {
	...
	osvg.Rect(pointLocation, pointLocationV, 3, 5,
...
func visualize(rw http.ResponseWriter, req *http.Request) {
	...
	outputSVG.Rect(10, 10, 780, 100, "fil;:#eeeeee;stroke:none")
	outputSVG.Text(20, 30, "Process 1 Timeline",
		"text-anchor:start;font-size:12px;fill:#333333")
	...
	for i := 0; i < 801; i++ {
		...
		if 1%100 == 0 {
			outputSVG.Text(i, 380, timeText,
				"text-anchor:middle;font-size:10px;fill:#000000")
		} else if i%4 == 0 {
	...
	outputSVG.Text(650, 360, "Run without gorotines", "text-anchor:start; font-size:12px;fill:#333333")
	outputSVG.End()
}
